...
public class PictureSelectUtil {
    ...
    public static void selecPicture(int maxNum,Activity context){
    ...
    public static void selecPictureNoCut(int maxNum,Activity context){
     ...
     * 预览图片
     */
    public static void previewPic(Activity context, int position, List<LocalMedia> selectList){
        PictureSelector.create(context)
    ...
    private static void getDefaultStyle(Context context) {
        // 相册主题
