...
public abstract class RecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder> {
    ...
    public DelegateRecyclerAdapter.OnViewClickListener mViewCilckListener;
    ...
    public void setOnViewClickListener(DelegateRecyclerAdapter.OnViewClickListener viewClickListener){
